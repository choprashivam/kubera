...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11 lg:hidden">
        ...
        {/* <div className="flex-grow flex-col text-sm ml-4 lg:hidden">
          <div className="font-light">Customer Name</div>
          <div className="font-thin">BrokerID</div>
        </div> */}

        {/* Client Selection Dropdown for Small Screens */}
        {props.isAdmin && (
          <div className="flex-grow flex-col ml-4 lg:hidden">
